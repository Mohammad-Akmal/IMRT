(function($) {
    ...
    /*-------------------------------------
     ...
     --------------------------------------*/
    $('nav#dropdown').meanmenu({ siteLogo: "<a href='index.html' class='logo-mobile-menu'><img src='public/uploads/logo/1671796882_1d05bea1bb553ca5c59b.png' style='width:90px'/></a>" });
